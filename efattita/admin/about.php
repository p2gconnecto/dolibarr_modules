...
/**
 * \file    efattita/admin/about.php
 * \ingroup efattita
 * \brief   About page of module eFattITA.
 */
...
dol_fiche_head($head, 'about', '', 0, 'efattita@efattita');

// dol_include_once('/efattita/core/modules/modeFattITA.class.php');
// $tmpmodule = new modeFattITA($db);
// print $tmpmodule->getDescLong();
echo 'Modulo per la fatturazione italiana prodotto da <a href="http://www.linx.ws">Linx s.r.l.s.</a>';
// Page end
dol_fiche_end();
llxFooter();
$db->close();
