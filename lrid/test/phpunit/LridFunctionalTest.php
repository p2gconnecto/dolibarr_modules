...
/**
 * \file    test/phpunit/LridFunctionalTest.php
 * \ingroup lrid
 ...
 * @package Testlrid
 */
class LridFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/lrid/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('lrid/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/lrid/admin/about.php');
		$this->authenticate();
		return $this->assertContains('lrid/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('lridwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modLrid_LridTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modLrid_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
